...
class C_admin_laporan extends CI_Controller {
    ...
    public function index()
    {
        if ($this->session->userdata('logged_in')) {
            ...
            $data['ppm']=$this->m_data->getTbbycond2("usulan, usulananggota, peneliti", "usulan.idusulan=usulananggota.idusulan && usulananggota.nipnim=peneliti.nipnim && usulananggota.posisi='Ketua' && usulan.statususulan='Didanai' $setperiode $setskema", "usulan.idusulan", "desc");
