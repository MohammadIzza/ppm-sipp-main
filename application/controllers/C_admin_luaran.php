...
class C_admin_luaran extends CI_Controller {
    ...
    public function index()
    {
        if ($this->session->userdata('logged_in')) {
            ...
            $iduser=$user['iduser'];
            $data['usulan']=$this->m_data->getTbbycond2("usulan, usulananggota, peneliti", "usulan.idusulan=usulananggota.idusulan and usulananggota.nipnim=peneliti.nipnim and usulan.statususulan='Didanai' group by usulan.idusulan", "usulan.idusulan", "desc");
            $data['ppm']=$this->m_data->getTbbycond2("usulanfile, jenisfile, usulan", "usulanfile.idjenis=jenisfile.idjenis and jenisfile.kategori='luaran' and usulanfile.idusulan=usulan.idusulan and usulan.statususulan='Didanai' $setperiode $setjenis", "usulanfile.idfile", "desc");
            ...
            $this->load->view('v_admin_luaran',$data);
        }else{
