                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center font-weight-bold my-2">
                                            ...
                                            <!--begin::Item-->
                                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                                            <a href="<?php echo base_url() . "index.php/c_upload_luaran"; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">Luaran</a>
                                            <!--end::Item-->
                                        </div>
                                        <!--end::Breadcrumb-->
                                    </div>
                                                        ...
                                                        <!--<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">-->
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%"><?php echo $data->judulluaran; ?></td>
                                                                    <td><?php echo $data->idjenis; ?></td>
                                                                    <td width="30%"><?php echo $data->keterangan; ?></td>
                                                                    ...
                                                                    <td class="text-center" width="5%" nowrap="nowrap">
                                                                        <!--begin::Button-->
                                                                        <a href="javascript:;" class="btn btn-sm btn-warning btn-clean btn-icon item_edit" title="Edit Luaran" data-toggle="tooltip" id="idfile" data="<?php echo $data->idfile;?>"><i class="la la-edit"></i></a>
                                                                        <a href="javascript:;" class="btn btn-sm btn-danger btn-clean btn-icon item_hapus" title="Hapus Luaran" data-toggle="tooltip" id="idfile" data="<?php echo $data->idfile;?>"><i class="la la-trash"></i></a>
...
<!--                                                    <div class="card-body">
                                                        ...
                                                        <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $i++; ?></td>
                                                                    <td><?php echo $data->judulluaran; ?></td>
                                                                    <td class="text-right"><?php echo $data->idjenis; ?></td>
                                                                    <td><?php echo $data->keterangan; ?></td>
                                                                    <td class="text-right"><?php echo $data->idperiode; ?></td>
                                                                    <td>
                                                                        <?php 
                                                                        if($data->fileloc != ""){ ?>
                                                                            <a href="<?php echo base_url().$data->fileloc; ?>" target="_blank" title="Klik untuk melihat dokumen">
                                                                                <img alt="" class="max-h-55px" src="<?php echo base_url() . 'dist/assets/media/svg/files/pdf.svg'?>"/>
                                                                            </a>
                                                                        <?php }else{ ?>
                                                                            <i class="fa la-file-pdf icon-4x" title="Luaran belum diunggah"></i>
                                                                        <?php } ?>
                                                                    </td>
                                                                    <td>
                                                                        begin::Button
                                        ...
                                        <div id="Modaleditluaran" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <!--<form class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/c_upload_luaran/editluaran">-->
...
//            
            $(document).ready(function(){
                $('body').on('change','#kt_datatable_search_periode', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_upload_luaran/setperiode') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response){
                            window.location='<?php echo base_url() . "index.php/c_upload_luaran"; ?>';
                        }
                    });
                    e.preventDefault(); 
                });
                $('body').on('change','#kt_datatable_search_jenis', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_upload_luaran/setjenis') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                ...
                $('#formtambahluaran').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>index.php/c_upload_luaran/uploadluaran', //URL submit
                ...
                $(document).on("click", ".item_edit", function () {
                      ...
                      $.ajax({
                          type: "GET",
                          url: "<?php echo base_url('index.php/c_upload_luaran/getluaran') ?>",
                          dataType: "JSON",
                          data: {idfile: idfile},
...
//                                  $('[name="file_edit"]').val(data.fileloc);
                ...
                $('#formueditluaran').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>index.php/c_upload_luaran/editluaran', //URL submit
                             type:"post", //method Submit
                             data:new FormData(this), //penggunaan FormData
                             processData:false,
                             contentType:false,
                    ...
                    Swal.fire({
                        ...
                        reverseButtons: true
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: "POST",
                                    url: "<?php echo base_url() . "index.php/c_upload_luaran/hapusluaran"; ?>",
                                    dataType: "JSON",
                                    data: {id: id},
                                    success: function(response) {
                                        if(response != 0){
