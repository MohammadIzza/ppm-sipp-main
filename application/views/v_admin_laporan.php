                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center font-weight-bold my-2">
                                            ...
                                            <!--begin::Item-->
                                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                                            <a href="<?php echo base_url() . "index.php/c_admin_laporan"; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">Laporan</a>
                                            <!--end::Item-->
                                        </div>
                                        <!--end::Breadcrumb-->
                                    </div>
                                                    ...
                                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                                        <div class="card-title">
                                                            <h3 class="card-label">Laporan Penelitian/Pengabdian
                                                                <span class="d-block text-muted pt-2 font-size-sm">Daftar Unggahan Laporan Penelitian/Pengabdian yang telah didanai</span></h3>
                                                        </div>
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <select class="form-control" id="kt_datatable_search_periode">
                                                                                    ...
                                                                                    <?php foreach($periode as $data): ?>
                                                                                        <option value="<?php echo $data->idperiode; ?>" <?php if(isset($_SESSION['periode-uplap'])&& $_SESSION['periode-uplap']==$data->idperiode){echo "selected"; }?>><?php echo $data->nama; ?></option>
                                                                                    <?php endforeach; ?>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <select class="form-control" id="kt_datatable_search_skema">
                                                                                    ...
                                                                                    <?php foreach($skema as $data): ?>
                                                                                        <option value="<?php echo $data->idskema; ?>" <?php if(isset($_SESSION['skema-uplap'])&& $_SESSION['skema-uplap']==$data->idskema){echo "selected"; }?>><?php echo $data->namaskema; ?></option>
                                                                                    <?php endforeach; ?>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <!--<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">-->
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-justify" width="30%"><?php echo $data->judul; ?></td>
                                                                    <td width="30%">
                                                                        <?php 
...
<!--                                                                        <a href="javascript:;" title="Unggah Laporan" class="btn btn-primary font-weight-bolder unggahfile" data-toggle="tooltip" id="idusulan" data="<?php echo $data->idusulan;?>">
...
//            });
            ...
            $(document).ready(function(){
                $('body').on('change','#kt_datatable_search_periode', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_admin_laporan/setperiode') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response){
                            window.location='<?php echo base_url() . "index.php/c_admin_laporan"; ?>';
                        }
                    });
                    e.preventDefault(); 
                });
                $('body').on('change','#kt_datatable_search_skema', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_admin_laporan/setskema') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
...
//                    alert('The file "' + fileName +  '" has been selected.');
                ...
                $('#formunggahfile').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>index.php/c_admin_laporan/uploadlaporan', //URL submit
