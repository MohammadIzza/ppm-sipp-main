        ...
        <div class="d-flex align-items-stretch mr-3">
            ...
            <div class="header-logo">
                <a href="<?php echo base_url() . "index.php/" ?>">
                    <img alt="Logo" src='<?php echo base_url() . "images/logo-fsm.png" ?>' class="logo-default max-h-40px" />
<!--                                        <img alt="Logo" src="assets/media/logos/logo-letter-9.png" class="logo-default max-h-40px" />
            ...
            <!--end::Header Logo-->
            <?php if($this->session->userdata['logged_in']['previledges']=='admin fakultas'){ ?>
            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default header-menu-root-arrow">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel <?php if(isset($_SESSION['menu'])){if (($_SESSION['menu'] == 'h-departemen') or ($_SESSION['menu'] == 'h-prodi')) echo 'menu-item-active'; }?>" data-menu-toggle="click" aria-haspopup="true">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="menu-text">Data Induk</span>
                                <i class="menu-arrow"></i>
                            </a>
                            <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                <ul class="menu-subnav">
                                    <li class="menu-item <?php if(isset($_SESSION['menu'])){if ($_SESSION['menu'] == 'h-departemen') echo 'menu-item-active'; }?>" aria-haspopup="true">
                                        <a href="<?php echo base_url() . "index.php/c_admin_departemen" ?>" class="menu-link">
                                            <span class="menu-text">Departemen</span>
                                            <span class="menu-desc"></span>
                                        </a>
                                    </li>
                                    <li class="menu-item <?php if(isset($_SESSION['menu'])){if ($_SESSION['menu'] == 'h-prodi') echo 'menu-item-active'; }?>" aria-haspopup="true">
                                        <a href="<?php echo base_url() . "index.php/c_admin_prodi" ?>" class="menu-link">
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel <?php if(isset($_SESSION['menu'])){if ($_SESSION['menu'] == 'jenisluaran') echo 'menu-item-active'; }?>" data-menu-toggle="click" aria-haspopup="true">
                            <a href="<?php echo base_url() . "index.php/c_admin_jenisluaran" ?>" class="menu-link">
                                <span class="menu-text">Jenis Luaran</span>
                            </a>
                        </li>
                    </ul>
                    <!--end::Header Nav-->
...
<!--            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                <!--begin::Toggle-->
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px"  title="Pengaturan Pendaftaran (Penjadwalan & Skema)">
                    <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1 pulse pulse-warning">
                        <span class="svg-icon svg-icon-danger svg-icon-xl">
                            <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo2\dist/../src/media/svg/icons\Shopping\Settings.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="pulse-ring icon-warning"></span>
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <!--begin:Header-->
                    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo base_url() . 'dist/assets/media/misc/bg-1.jpg'?>)">
                        <h4 class="text-white font-weight-bold">Pengaturan Pendaftaran</h4>
                    ...
                    <div class="row row-paddingless">
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="<?php echo base_url() . "index.php/c_admin_periode" ?>" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo2\dist/../src/media/svg/icons\Code\Time-schedule.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                                ...
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Penjadwalan</span>
                                <span class="d-block text-dark-50 font-size-lg">Periode Pendaftaran</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="<?php echo base_url() . "index.php/c_admin_skema" ?>" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                ...
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Skema</span>
                                <span class="d-block text-dark-50 font-size-lg">Penelitian Pengabdian</span>
                            </a>
                        </div>
                        <!--end:Item-->
                    </div>
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item">
                    <div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto" id="kt_quick_user_toggle" title="Profil Saya">
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <a href="#" class="menu-link menu-toggle">
                                <span class="menu-text text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">
                                    &ensp;Hi, <?php $nama = explode(" ", $this->session->userdata['logged_in']['name']); echo ucfirst($nama[0]);?>
                                </span>
                                <span class="symbol symbol-35">
                                    <span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">
                                        <span class="svg-icon svg-icon-xl svg-icon-white"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo2\dist/../src/media/svg/icons\Communication\Shield-user.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
                                                <path d="M4,4 L11.6314229,2.5691082 C11.8750185,2.52343403 12.1249815,2.52343403 12.3685771,2.5691082 L20,4 L20,13.2830094 C20,16.2173861 18.4883464,18.9447835 16,20.5 L12.5299989,22.6687507 C12.2057287,22.8714196 11.7942713,22.8714196 11.4700011,22.6687507 L8,20.5 C5.51165358,18.9447835 4,16.2173861 4,13.2830094 L4,4 Z" fill="#000000" opacity="0.3"/>
                            ...
                            <?php } else { ?>
                            <a href="<?php echo base_url() . "index.php/welcome/loadpagesignin" ?>" class="menu-link menu-toggle">
                                <span class="menu-text text-white opacity-90 font-weight-bolder font-size-base d-none d-md-inline mr-4">
                                    <li class="fas fa-sign-in-alt"></li> SIGN UP - SIGN IN</span>
                                <!--<i class="menu-arrow"></i>-->
                            </a>
                            <?php } ?>
...
<!--            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        begin::Header
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo base_url() . 'dist/assets/media/misc/bg-1.jpg'?>)">
                            begin::Title
...
<!--            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                    <form>
                        begin::Header
                        <div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?php echo base_url() . 'dist/assets/media/misc/bg-1.jpg'?>)">
...
<!--            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm" src="<?php echo base_url() . 'dist/assets/media/svg/flags/226-united-states.svg'?>" alt="" />
                    </div>
                </div>
                end::Toggle
                begin::Dropdown
                <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                    ...
                    <ul class="navi navi-hover py-4">
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="<?php echo base_url() . 'dist/assets/media/svg/flags/226-united-states.svg' ?>" alt="" />
                                </span>
                        ...
                        <li class="navi-item active">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="<?php echo base_url() . 'dist/assets/media/svg/flags/128-spain.svg' ?>" alt="" />
                                </span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="<?php echo base_url() . 'dist/assets/media/svg/flags/162-germany.svg' ?>" alt="" />
                                </span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="<?php echo base_url() . 'dist/assets/media/svg/flags/063-japan.svg' ?>" alt="" />
                                </span>
                        ...
                        <li class="navi-item">
                            <a href="#" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="<?php echo base_url() . 'dist/assets/media/svg/flags/195-france.svg' ?>" alt="" />
                                </span>
            ...
            <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                            <a href="<?php echo base_url() . "index.php/#pengumuman"?>" class="menu-link">
                                <span class="menu-text">Berita Terkini</span>
                                <i class="menu-arrow"></i>
                            </a>
                        </li>
                        <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                            <a href="<?php echo base_url() . "index.php/welcome/download/#pengumuman" ?>" class="menu-link">
                                <span class="menu-text">Download Area</span>
                                <i class="menu-arrow"></i>
                            </a>
                        </li>
                    </ul>
...
<!--                                            <span class="symbol symbol-35">
                            <span class="symbol-label text-white font-size-h5 font-weight-bold bg-white-o-30">LOGIN</span>
                        </span>-->
                    </div>
                </div>
                <!--end::Toggle-->
