                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center font-weight-bold my-2">
                                            ...
                                            <!--begin::Item-->
                                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                                            <a href="<?php echo base_url() . "index.php/c_upload_laporan"; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">Laporan</a>
                                            <!--end::Item-->
                                        </div>
                                        <!--end::Breadcrumb-->
                                    </div>
                                                ...
                                                <div class="card card-custom">
                                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                                        <div class="card-title">
                                                            <h3 class="card-label">Laporan Penelitian/Pengabdian
                                                                <span class="d-block text-muted pt-2 font-size-sm">Daftar Unggahan Saya</span></h3>
                                                        </div>
                                                        ...
                                                        <!--<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">-->
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    if($jenisfile != null){
                                                                        $i=5;
                                                                        foreach($jenisfile as $row):
                                                                            $nm=str_replace("Laporan","Lap",$row->namafile);
                                                                            echo "<th Field #".$i++.">".$nm."</th>";
                                                                        endforeach;
                                                                    }
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    if($jenisfile != null){
                                                                        foreach($jenisfile as $row):
                                                                            $q = $this->db->query("SELECT fileloc from usulanfile where idusulan='$data->idusulan' && idjenis in(select idjenis from jenisfile where idjenis='$row->idjenis')");
                                                                            if ($q->num_rows() > 0) {
                                                                            foreach ($q->result() as $r) { ?>
                                                                                <td width="10%">
                                                                                    <a href="<?php echo base_url().$r->fileloc; ?>" target="_blank"><?php echo $row->namafile ; ?></a>
                                                                                </td>
                                                                            <?php }
                                                                            }else{
                                                                                echo "<td><span style='font-size:7pt'>Belum Diunggah</span></td>";
                                                                            }
                                                                        endforeach;
                                                                    }
                                                                    ...
                                                                    <td width="5%">
                                                                        ...
                                                                        $now = time();
                                                                        $date_end = $data->end_laporan." 23:59:59"; #could be (almost) any string date
                                                                        if ($data->end_laporan='0000-00-00' && $now < strtotime($date_end)) { 
                                                                        ?>
                                                                        <!--begin::Button-->
                                                                        <a href="javascript:;" class="btn btn-sm btn-primary btn-clean btn-icon unggahfile" title="Unggah Laporan" data-toggle="tooltip" id="idusulan" data="<?php echo $data->idusulan;?>"><i class="la la-upload"></i></a>
<!--                                                                        <a href="javascript:;" class="btn btn-primary font-weight-bolder unggahfile" title="Unggah Laporan" data-toggle="tooltip" id="idusulan" data="<?php echo $data->idusulan;?>">

                                                                            <span class="svg-icon svg-icon-md">begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo2\dist/../src/media/svg/icons\Files\Cloud-upload.svg<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                    <polygon points="0 0 24 0 24 24 0 24"/>
                                                                        ...
                                                                        <!--end::Button-->
                                                                        <?php }else{ ?>
                                                                        <a href="javascript:;" class="btn btn-sm btn-secondary btn-clean btn-icon" title="Batas Unggah Laporan Berakhir" data-toggle="tooltip" id="idusulan" data="<?php echo $data->idusulan;?>"><i class="la la-upload"></i></a>
                                                                        <?php } ?>
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach; } ?>
...
<!--                                                    <div class="card-body">
                                                        ...
                                                        <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        begin::Button
                                                                        <a href="javascript:;" class="btn btn-primary font-weight-bolder unggahfile" data-toggle="tooltip" id="idusulan" data="<?php echo $data->idusulan;?>">
                                        ...
                                        <!--end::Row-->
                                        <!--end::Dashboard-->
                                        <!--begin::Modal Unggah File-->
                                        <div id="Modalunggahfile" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Unggah Laporan Saya</h4>
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>                        
                                                    </div>
                                                    <form class="form-horizontal" method="post" id="formunggahfile">
                                                        <div class="modal-body">
                                                            <input name="idusulan" id="id_peserta_edit" class="form-control" type="hidden">
                                                            <div class="form-group row">
                                                                <label class="col-form-label text-left col-lg-3 col-sm-12"><b>Jenis Laporan Anda</b></label>
                                                                <select name="idjenis" class="form-control select2" id="kt_select2_2" required="">
                                                                    <option value="">&ensp;&ensp; Pilih Jenis Laporan &ensp;&ensp;</option>
                                                                    <?php 
                                                                    if ($jenisfile != null) {
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <label class="btn btn-outline-success">
                                                                    <input type="file" name="file"><i class="flaticon-upload"></i> Pilih File                                                                    
                                                                </label>
                                                            </div>
                                                            <div class="form-group row">
...
//                    alert('The file "' + fileName +  '" has been selected.');
                ...
                $('#formunggahfile').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>index.php/c_upload_laporan/uploadlaporan', //URL submit
                             ...
                             async:false,
                              success: function(response){
                                    if(response != 0){
                                        swal.fire({title: "Berhasil", text: "Laporan berhasil disimpan.", icon: "success",buttonsStyling:true, confirmButtonText: "OK"},
                                            ).then(function() {
                                                location.reload();
                                        });    
                                    }else{
                                        swal.fire({title: "Oops...", text: "Laporan gagal disimpan", icon: "error",buttonsStyling:true, confirmButtonText: "OK"},
                                        );
                                    }
                                }
                         });
