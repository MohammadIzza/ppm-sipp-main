<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href=<?php echo base_url() . "dist/assets/css/pages/error/error-5.css"?> rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" style="background-image: url(<?php echo base_url() . 'dist/assets/media/bg/bg-10.jpg'?>)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo base_url() . 'dist/assets/media/error/bg5.jpg'?>);">
				<!--begin::Content-->
				<div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
					<h1 class="error-title font-weight-boldest text-info mt-10 mt-md-0 mb-12">Oops!</h1>
					<p class="font-weight-boldest display-4"><?php echo $highlight; ?></p>
					<p class="font-size-h3"><?php echo $msg1; ?></p>
                                        <p class="font-size-h3"><?php echo $msg2; ?></p>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
