<!--begin::Hero-->
    <div class="card card-custom overflow-hidden position-relative mb-8" style="height: 300px">
            <!--begin::SVG-->
            ...
            <div class="position-absolute d-flex top-0 right-0 offset-lg-5 col-lg-6 opacity-30 opacity-lg-100">
                    <span class="svg-icon svg-icon-full flex-row-fluid p-15">
                            <!--begin::Svg Icon | path:assets/media/svg/illustrations/working.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="e66d77ca-31e8-442d-a5de-b801817c4280" data-name="Layer 1" width="1024.7" height="571.65" viewBox="0 0 1024.7 671.65">
            ...
            <div class="wave wave-animate-slow wave-success mb-8 mb-xl-0">
                <div class="card-body">
            ...
            <div class="card-body d-flex justify-content-center flex-column col-lg-6 px-8 py-20 px-lg-20 py-lg-40">
                    <!--begin::Heading-->
                    <h2 class="text-dark font-weight-bolder mb-8">Cari informasi terbaru seputar PPM ?</h2>
                    <!--end::Heading-->
                    <!--begin::Form-->
                    <form class="d-flex position-relative flex-row-fluid" class="form" method="post" action="<?php echo base_url(); ?>index.php/welcome/caripengumuman">
                            <div class="input-group shadow-sm">
                                    <div class="input-group">
                                            <span class="input-group-text bg-white border-0 py-7 px-8"> 
                                            </span>
                                        <input name="katakunci" type="text" class="form-control h-auto border-0 py-7 px-1 font-size-lg" placeholder="Masukkan kata kunci pencarian" required=""/>
                                            <div class="input-group-append">
                                                <button class="btn btn-secondary" type="submit" title="Klik untuk mulai pencarian">
    ...
    <!--                                                                    <div class="input-group-prepend">
                                    ...
                                    begin::Input
                                    <input type="text" class="form-control h-auto border-0 py-7 px-1 font-size-lg submit_on_enter" placeholder="Masukkan kata kunci pencarian" />-->
                                    <!--end::Input-->
                            </div>
                    </form>
                    <!--end::Form-->
