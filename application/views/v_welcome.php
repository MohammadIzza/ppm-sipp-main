                                    ...
                                    <div class="card-header card-header-left ribbon ribbon-clip ribbon-left">
                                        ...
                                        <span class="card-title h2" style="padding-left:30px">
                                            <?php if(isset($_SESSION['search'])){ ?>
                                                Hasil Pencarian '<i class="text-success"><?php echo $_SESSION['search_awal']; ?></i>'  menampilkan &nbsp;<b class="text-success"><?php echo $jmldata?></b>&nbsp; data
                                            <?php }else{ echo "Berita Terkini"; } ?>
                                        </span>  
                                    </div>
                                    <div class="card-body">
                                            <!--begin::Example-->
                                                                ...
                                                                <div class="timeline-items">
                                                                    <?php if($pengumuman != null){
                                                                        foreach ($pengumuman as $data) : 
                                                                            $datetime = $data->tglpos;
                                                                            $pisah = explode(' ', $datetime);
                                                                            $tgl = $pisah[0];
                                                                            $waktu = $pisah[1];
                                                                            $tgl_pos = explode('-', $tgl);
                                                                            ?> 
                                                                        ...
                                                                        <div class="timeline-item">
                                                                                ...
                                                                                <div class="timeline-media bg-light-primary">
                                                                                    <span class="flaticon2-bell text-primary icon-lg"></span>
                                                                                </div>
                                                                                <!--end::Icon-->
                                                                                <!--begin::Info-->
                                                                                <div class="timeline-desc timeline-desc-light-secondary">
                                                                                        <span class="h4 font-weight-bolder"><?php echo $data->judul;?></span>
                                                                                        <div class="" style="padding-top:5px;font-size: 9pt">
                                                                                            <span class="flaticon-calendar-with-a-clock-time-tools text-warning icon-md"></span> Tanggal <?php echo $tgl_pos[2] . "-" . $tgl_pos[1] . "-" . $tgl_pos[0]; ?> &ensp;&ensp;
                                                                                            <span class="flaticon-time text-warning icon-md"></span> &ensp;<?php echo $waktu; ?>
                                                                                        </div>
                                                                                        <p class="font-weight-normal text-dark-50 pb-2" ><?php echo $data->isi;?></p>
                                                                                        <?php 
                                                                                        $query = $this->db->query("SELECT * from pengumumanlampiran where idpengumuman='$data->idpengumuman'");
                                                                                        if ($query->num_rows() > 0) {?>
                                                                                        <!--begin::Engage Widget 7-->
                                                                                        <div class="card card-custom card-stretch gutter-b">
                                                                                            <div class="card-body d-flex p-0">
                                                                                                <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start bg-primary-o-30" style="background-color: #1BC5BD; background-position: right bottom; background-size: auto 100%; background-image: url(<?php echo base_url() . 'dist/assets/media/svg/humans/custom-8.svg'?>)">
                                                                                                    <h4 class="text-primary font-weight-bolder m-0">Lampiran</h4>                                                                                                                    
                                                                                                    <?php 
                                                                                                        foreach ($query->result() as $row) { 
                                                                                                            ?>
                                                                                                        <div class="mt-5">
                                                                                                            <span class="svg-icon svg-icon-md svg-icon-primary flex-shrink-0 mr-3">
                                                                                                            ...
                                                                                                            <a href="<?php echo base_url() . $row->lampiran; ?>">
                                                                                                                <span class="text-primary">Unduh <b><?php echo $row->namalampiran;?></b></span>
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    <?php } ?>                                                                                                                    
                                                                                                </div>
                                                                        ...
                                                                        <div class="timeline-item">
                                                                            <p class="font-weight-normal text-dark-50 pb-2" >
                                                                                <?php if(isset($_SESSION['search'])){
                                                                                        echo "Maaf, kata kunci yang anda cari tidak ditemukan";
                                                                                    }else{
