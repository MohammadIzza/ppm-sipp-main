                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center font-weight-bold my-2">
                                            ...
                                            <!--begin::Item-->
                                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                                            <a href="<?php echo base_url() . "index.php/c_prodi_luaran"; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">Luaran</a>
                                            <!--end::Item-->
                                        </div>
                                        <!--end::Breadcrumb-->
                                    </div>
                                                ...
                                                <div class="card card-custom">
                                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                                        <div class="card-title">
                                                            <h3 class="card-label">Luaran Penelitian/Pengabdian Prodi <?php echo $namaprodi; ?>
...
//            });
            ...
            $(document).ready(function(){
                $('body').on('change','#kt_datatable_search_periode', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_prodi_luaran/setperiode') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response){
                            window.location='<?php echo base_url() . "index.php/c_prodi_luaran"; ?>';
                        }
                    });
                    e.preventDefault(); 
                });
                $('body').on('change','#kt_datatable_search_jenis', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_prodi_luaran/setjenis') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                ...
                $('#formtambahluaran').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>index.php/c_prodi_luaran/uploadluaran', //URL submit
                ...
                $(document).on("click", ".item_edit", function () {
                      ...
                      $.ajax({
                          type: "GET",
                          url: "<?php echo base_url('index.php/c_prodi_luaran/getluaran') ?>",
                          dataType: "JSON",
                          data: {idfile: idfile},
...
//                                  $('[name="file_edit"]').val(data.fileloc);
                ...
                $('#formueditluaran').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>index.php/c_prodi_luaran/editluaran', //URL submit
                             type:"post", //method Submit
                             data:new FormData(this), //penggunaan FormData
                             processData:false,
                             contentType:false,
                    ...
                    Swal.fire({
                        ...
                        reverseButtons: true
                            ...
                            if (result.value) {
                                $.ajax({
                                    type: "POST",
                                    url: "<?php echo base_url() . "index.php/c_prodi_luaran/hapusluaran"; ?>",
                                    dataType: "JSON",
                                    data: {id: id},
                                    success: function(response) {
                                        if(response != 0){
