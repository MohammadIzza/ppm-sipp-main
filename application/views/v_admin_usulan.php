                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center font-weight-bold my-2">
                                            ...
                                            <a href="<?php echo base_url() . "index.php/c_admin_usulan"; ?>" class="text-white text-hover-white opacity-75 hover-opacity-100">Proposal Usulan</a>
                                            <!--end::Item-->
                                            <!--begin::Item-->
<!--                                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                                                    ...
                                                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                                        <div class="card-title">
                                                            <h3 class="card-label">Penelitian dan Pengabdian
                                                                <span class="d-block text-muted pt-2 font-size-sm">Daftar Usulan Penelitian dan Pengabdian Peneliti</span></h3>
                                                        </div>
                                                        <div class="card-toolbar">
                                                            <div class="dropdown dropdown-inline mr-2">
                                                                ...
                                                                if($lastperiode!=null){
                                                                    ...
                                                                    $now = time();
                                                                    $date_start = $lastperiode[0]->start." 00:00:00"; #could be (almost) any string date
                                                                    $date_end = $lastperiode[0]->end." 23:59:59"; #could be (almost) any string date
                                                                ...
                                                                ?>
                                                                <!--begin::Button-->
                                                                <a href="javascript:;" class="btn btn-primary font-weight-bolder editperiode" id="idperiode" data="<?php echo $lastperiode[0]->idperiode;?>" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Pengajuan Proposal sampai tanggal <?php echo $dateline; ?> pukul 23:59">
                                                                    <span class="svg-icon svg-icon-md svg-icon-default"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo2\dist/../src/media/svg/icons\Home\Timer.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<!--                                                                        <li class="navi-item">
                                                                        ...
                                                                        <li class="navi-item">
                                                                            <a href="<?php echo base_url() . "index.php/c_admin_usulan/export"; ?>" class="navi-link">
                                                                                <span class="navi-icon">
                                                                            ...
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <select class="form-control" id="kt_datatable_search_periode">
                                                                                    ...
                                                                                    <?php foreach($periode as $data): ?>
                                                                                        <option value="<?php echo $data->idperiode; ?>" <?php if(isset($_SESSION['periode'])&& $_SESSION['periode']==$data->idperiode){echo "selected"; }?>><?php echo $data->nama; ?></option>
                                                                                    <?php endforeach; ?>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <!--<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">-->
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th title="Field #4">Usulan-Dana</th>
                                                                    <th title="Field #5">Periode</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="20%" class="text-justify"><?php echo $data->judul; ?></td>
                                                                    <td width="15%">
                                                                        <?php 
                                                                    ...
                                                                    <td  width="12%"><?php echo "Rp " . number_format($data->dana,2,',','.'); ?></td>
                                                                    <td><?php echo $data->idperiode; ?></td>
                                                                    <td><?php echo $data->idskema; ?></td>
                                                                    <td>
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        if ($query->num_rows() > 0) {
                                                                            foreach ($query->result() as $row) { ?>
                                                                                    <a href="<?php echo base_url().$row->fileloc; ?>" target="_blank" title="Klik untuk melihat dokumen" data-toggle="tooltip" >
                                                                                        <img alt="" class="max-h-55px" src="<?php echo base_url() . 'dist/assets/media/svg/files/pdf.svg'?>"/>
                                                                                    </a>
                                                                                <?php   
                                                                             }
                                                                        }else{ ?>
                                                                        <i class="fa la-file-pdf icon-4x" title="Proposal belum diunggah" data-toggle="tooltip" ></i>
                                                                        <?php } ?>
                                                                    </td>
                                                                    <td width="15%">
                                                                        <select name="statususulan" id="selectketetapan" class="form-control" title="Penetapan Usulan" data-toggle="tooltip" >
                                                                            <option value="">-Ketetapan-</option>
                                                                            <option value="<?php echo $data->idusulan."-Didanai"?>" <?php if($data->statususulan=="Didanai"){echo "selected"; }?>>Didanai</option>
                                                                            <option value="<?php echo $data->idusulan."-Tidak Didanai"?>" <?php if($data->statususulan=="Tidak Didanai"){echo "selected"; }?>>Ditolak</option>                                                                            
                                                                        </select><br/>
                                                                        <?php // if($data->statususulan=='Didanai'){ ?>
                                                                        <input type="number" id="<?php echo $data->idusulan;?>" class="form-control pendanaan" value="<?php if($data->danadisetujui != 0){ echo $data->danadisetujui;}?>" min="0" placeholder="Dana Disetujui" title="Jumlah dana yg disetujui" data-toggle="tooltip" >
                                                                        <?php // } ?>
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach; } ?>
                                        ...
                                        <div id="ModalPeriode" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg" aria-hidden="true" data-keyboard="false" data-backdrop="static">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form-horizontal" method="post" id="formeditperiode">
                                                        <div class="modal-body">
                                                            <input name="idperiode_edit" class="form-control" type="hidden">
                                                            <div class="form-group row">
                                                                <label class="col-form-label text-right col-lg-3 col-sm-12">Nama Periode</label>
                                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                                    <input name="nama_edit" type="text" class="form-control" placeholder="Nama Perode" required=""/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-form-label text-right col-lg-3 col-sm-12">Mulai</label>
                                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                                    <input name="start_edit" type="text" class="form-control" id="kt_datepicker_3" readonly="readonly" placeholder="Pilih Tanggal" required=""/>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-form-label text-right col-lg-3 col-sm-12">Berakhir</label>
                                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                                    <input name="end_edit" type="text" class="form-control" id="kt_datepicker_3" readonly="readonly" placeholder="Pilih Tanggal" required=""/>
                                                                </div>
                                                            </div>
...
//                      });
//                      
//                      $('#kt_datatable_search_periode').on('change', function() {
...
//            });
            ...
            $(document).ready(function(){
                $('body').on('change','#kt_datatable_search_periode', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_admin_usulan/setperiode') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response){
                            window.location='<?php echo base_url() . "index.php/c_admin_usulan"; ?>';
                        }
                    });
                    e.preventDefault(); 
                });
                $('body').on('change','#kt_datatable_search_skema', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_admin_usulan/setskema') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                ...
                $('body').on('change','#kt_datatable_search_status', function() {
                    ...
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_admin_usulan/setstatus') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                ...
                $(document).on("click", ".editperiode", function () {
                      var idperiode = $(this).attr('data');
                      $.ajax({
                          type: "GET",
                          url: "<?php echo base_url('index.php/c_admin_usulan/getperiode') ?>",
                          dataType: "JSON",
                          data: {idperiode: idperiode},
                          success: function (data) {
                              $.each(data, function (idperiode, nama, start, end) {
                                  $('#ModalPeriode').modal('show');
                                  $('[name="idperiode_edit"]').val(data.idperiode);
                                  $('[name="nama_edit"]').val(data.nama);
                                  $('[name="start_edit"]').val(data.start);
                                  $('[name="end_edit"]').val(data.end);
                  ...
                  $('#formeditperiode').submit(function(e){
                    e.preventDefault(); 
                         $.ajax({
                             url:'<?php echo base_url();?>index.php/c_admin_usulan/editperiode', //URL submit
                             ...
                             async:false,
                              success: function(response){
                                    if(response != 0){
                                        swal.fire({title: "Berhasil", text: "Perubahan periode berhasil disimpan.", icon: "success",buttonsStyling:true, confirmButtonText: "OK"},
                                            ).then(function() {
                                                location.reload();
                                        });    
                                    }else{
                                        swal.fire({title: "Oops...", text: "Perubahan periode gagal disimpan", icon: "error",buttonsStyling:true, confirmButtonText: "OK"},
                                        );
                                    }
                                }
                         });
                });
                $('body').on('change','#selectketetapan', function() {
                    var fd = new FormData();
                    var id = this.value
                    
                    fd.append('id',id);
                     $('#show_selected').val(id);
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_admin_usulan/ketetapan') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response){
                            if(response != 0){
                                swal.fire({title: "Berhasil", text: "Ketetapan berhasil disimpan.", icon: "success",buttonsStyling:true, confirmButtonText: "OK"},
                                    )
//                                    .then(function() {
//                                        location.reload();
//                                    })
                                ...
                                swal.fire({title: "Oops...", text: "Ketetapan gagal disimpan", icon: "error",buttonsStyling:true, confirmButtonText: "OK"},
                                        );
                            }
                        }
                    });
                ...
                $('body').on('change','.pendanaan', function() {
                    var id = this.id;
                    var value = this.value;
                
                    var fd = new FormData();
                    fd.append('idusulan',id);
                    fd.append('danadisetujui',value);
                    
                    // AJAX request
                    $.ajax({
                        url: '<?php echo base_url('index.php/c_admin_usulan/pendanaan') ?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
                        success: function(response){
                            if(response != 0){
                                swal.fire({title: "Berhasil", text: "Pendanaan proposal berhasil disimpan.", icon: "success",buttonsStyling:true, confirmButtonText: "OK"},
                                    )
//                                    .then(function() {
//                                        location.reload();
//                                    })
                                ...
                                swal.fire({title: "Oops...", text: "Pendanaan proposal gagal disimpan. Ketetapan belum dipilih.", icon: "error",buttonsStyling:true, confirmButtonText: "OK"},
                                        );
                            }
                        }
                    });
