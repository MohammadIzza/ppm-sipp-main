<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Error | Website Under Maintenance</title>
		...
		<link href=<?php echo base_url() . "dist/assets/css/pages/error/error-6.css"?> rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" style="background-image: url(<?php echo base_url() . 'dist/assets/media/bg/bg-10.jpg'?>)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo base_url() . 'dist/assets/media/error/bg6.jpg'?>);">
				<!--begin::Content-->
				<div class="d-flex flex-column flex-row-fluid text-center">
					<h1 class="error-title font-weight-boldest text-white mb-12" style="margin-top: 12rem;">Oops...</h1>
					<p class="display-4 font-weight-bold text-white">Website dalam perbaikan. Kembali lagi nanti ya.</p>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
